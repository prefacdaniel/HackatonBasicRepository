...
public class AuthenticationService {
    ...
    public AuthenticationService(String deviceID, String activationDeviceID, String secret, byte[] privateKey) {
        this.deviceID = deviceID;
        this.activationDeviceID = activationDeviceID;
        this.secret = secret;
    ...
    public String authenticate(boolean isActivationToken) throws Exception {
        ...
        if (isActivationToken) {
            signatureEncoded = Base64.getUrlEncoder().encodeToString(sha256HMAC(secret, data));
        } else {
