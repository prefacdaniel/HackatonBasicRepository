...
public class ReadDeviceToCloudMessages {
    ...
    // {your IoT Hub name}
    private static final String eventHubsCompatibleEndpoint = "sb://iothub-ns-hacktathon-940917-5b914df80b.servicebus.windows.net/";

    // az iot hub show --query properties.eventHubEndpoints.events.path --name {your
    // IoT Hub name}
    private static final String eventHubsCompatiblePath = "hacktathoniothub";

    // az iot hub policy show --name iothubowner --query primaryKey --hub-name {your
    // IoT Hub name}
    private static final String iotHubSasKey = "oySxZiazSkGfYTTxIL4Ih008Q7Vy90GkvmXHMG2ve7s=";
    ...
    public static void main(String[] args)
        ...
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setEndpoint(new URI(eventHubsCompatibleEndpoint)).setEventHubName(eventHubsCompatiblePath)
                .setSasKeyName(iotHubSasKeyName).setSasKey(iotHubSasKey);
